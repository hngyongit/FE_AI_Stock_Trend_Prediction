...
module.exports = {
  ...
  safelist: [
    {
      pattern:
        /(bg|border|text|stroke|fill)-(primary|secondary|tertiary|error|success|warning|info|typography|outline|background|indicator|market|surface|chart)-(0|50|100|200|300|400|500|600|700|800|900|950|white|gray|black|error|warning|muted|success|info|light|dark|primary|up|down|flat|grid|crosshair)/,
    },
  ],
  theme: {
    extend: {
