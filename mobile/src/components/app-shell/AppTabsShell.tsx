...
import type { MainTabParamList, RootScreenProps } from '@/navigation/types';
import { AppHeader } from '@/shared/components/navigation/AppHeader';
import { AppTabBar } from '@/shared/components/navigation/AppTabBar';
...
export default function AppTabsShell() {
